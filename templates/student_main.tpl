...
<div id="studentContent" class="student-filters">
	<div class="filter-box">
        ...
        <div class="section-header" ondblclick="expandReduce('practical'); return false;">
            <h3>Informations pratiques</h3>
            <a href="#" onclick="expandReduce('practical'); return false;"><img src="images/reduce.gif" id="practicalImg" /></a>
        </div>
    ...
    <div class="filter-box">
        <div class="section-header" ondblclick="expandReduce('teaching'); return false;">
            <h3>Enseignement</h3>
            <a href="#" onclick="expandReduce('teaching'); return false;"><img src="images/reduce.gif" id="teachingImg" /></a>
        </div>
        ...
        <div id="teaching">
            ...
            <span id="teachingSubjects">
                ...
                <input type="checkbox" name="teachingLevel-1" id="teachingLevel-1" value="1" id="teachingLevel-1" onclick="checkLevel( 1 ); formOnChange( );" {teachingLevel-1Checked} /> Gymnase<br />
                    <div class="subject-indent" id="teachingLevel-1Opts">
                ...
                <div class="subject-indent" id="teachingLevel-2Opts">
    ...
    <div class="filter-box">
        <div class="section-header" ondblclick="expandReduce('rep'); return false;">
            <h3>Informations répétiteur</h3>
            <a href="#" onclick="expandReduce('rep'); return false;"><img src="images/reduce.gif" id="repImg" /></a>
        </div>
